			...
			<form onSubmit={handleSubmit} className="row">
				<div className="col-md-6">
					<Select
						...
						placeholder="Selectionner un PdV"
						value={bon.pdv}
					...
					<Select
						name="technicien"
						label="Technicien"
						placeholder="Selectionner un technicien"
						value={bon.technicien}
						onChange={handleChange}
					...
					<Select
						name="kwf"
						label="KWF"
						placeholder="Selectionner un KWF"
						value={bon.kwf}
						error={errors.kwf}
						onChange={handleChange}
					>
					...
					<div className="form-group">
						<div className="form-check">
							...
							/>
							<label className="form-check-label">Travaux de garantie</label>
						</div>
					</div>
				</div>
				<div className="col-md-6">
					...
					<div className="d-flex justify-content-between">
						<Link to="/bons" className="btn  btn-light">
							Retour à la liste
						</Link>
