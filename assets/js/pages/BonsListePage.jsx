	...
	return (
		<>
			<div className="mb-3 d-flex justify-content-between align-items-center">
				...
				<Link to="/bons/new" className="btn btn-primary">
					...
					{paginatedBons.map((bon) => (
						<tr key={bon.id}>
							...
							<td className="text-center">
								<span className={"badge badge-" + ETAT_CLASSES[bon.etat]}>
									{ETAT_LABEL[bon.etat]}
								</span>
							</td>
							<td>{bon.pdv.nom}</td>
							...
							<td>
								{bon.createdBy.prenom} {bon.createdBy.nom}
							</td>
							<td>
